...
function getDeadline() {
  ...
  const deadline = Date.now() + 7 * 24 * 60 * 60 * 1e3;
...
function getSeats() {
  ...
  const now2 = Date.now();
  const elapsed = now2 - lastTick;
  if (elapsed > 0) {
    const ticks = Math.floor(elapsed / 3e4);
    if (ticks > 0) {
      seats = Math.max(11, seats - ticks);
      localStorage.setItem(SEATS_KEY, String(seats));
      localStorage.setItem(SEATS_TS_KEY, String(lastTick + ticks * 3e4));
    }
  } else {
    localStorage.setItem(SEATS_TS_KEY, String(now2));
  }
  return seats;
}
function useCountdown() {
  const [deadline] = reactExports.useState(getDeadline);
  ...
  const seconds = Math.floor(remaining % (1e3 * 60) / 1e3);
  return { days, hours, minutes, seconds, expired: remaining === 0 };
}
function useSeats() {
  const [seats, setSeats] = reactExports.useState(getSeats);
  reactExports.useEffect(() => {
...
function useJoinTicker() {
  ...
  return { message: JOIN_NOTIFICATIONS[index2], visible };
}
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        style: {
          ...
          boxShadow: "0 0 18px oklch(0.62 0.22 255 / 0.15), inset 0 1px 0 oklch(0.4 0.1 255 / 0.1)",
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-2 mb-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { size: 15, style: { color: "oklch(0.72 0.2 155)" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              className: "text-sm font-bold uppercase tracking-widest",
              style: { color: "oklch(0.72 0.2 155)" },
              children: "⚡ This Week's Free Access Closes In..."
            }
          )
        ] }),
        expired ? /* @__PURE__ */ jsxRuntimeExports.jsx(
          "p",
          {
            ...
            children: "This offer has ended."
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-center gap-3 sm:gap-5 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TimerBox, { value: days, label: "Days" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TimerBox, { value: hours, label: "Hours" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "text-2xl sm:text-3xl font-bold mt-4 sm:mt-5",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TimerBox, { value: minutes, label: "Min" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                className: "text-2xl sm:text-3xl font-bold mt-4 sm:mt-5",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TimerBox, { value: seconds, label: "Sec" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "p",
            {
              ...
              children: [
                "After this window closes, new members must wait for the next opening.",
                " ",
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "oklch(0.78 0.06 240)" }, children: "Don't miss what insiders already know." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function SubscribeBar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-center gap-4 relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row items-center gap-3 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "p",
            {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        boxShadow: "0 0 48px oklch(0.62 0.22 255 / 0.18), 0 8px 32px rgba(0,0,0,0.5)"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { size: 16, className: "text-blue-glow" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
              ...
              children: "Finance Pro Community"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-2 mb-4", children: stats.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(s.icon, { size: 14, className: `${s.color} mx-auto mb-1` }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs mb-2", style: { color: "oklch(0.55 0.04 240)" }, children: "Topics Covered" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: topics.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5 mb-1", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { size: 12, className: "text-green-glow" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    className: "text-xs font-semibold",
                    style: { color: "oklch(0.78 0.18 155)" },
                    children: "Today's Insight"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs", style: { color: "oklch(0.72 0.04 240)" }, children: "Understanding diversification: why spreading investments across asset classes reduces risk over the long term." })
            ]
          }
        )
      ]
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "nav",
    {
      ...
      style: {
        background: scrolled ? "oklch(0.09 0.018 250 / 0.95)" : "oklch(0.09 0.018 250 / 0.6)",
        backdropFilter: "blur(16px)",
        borderBottom: scrolled ? "1px solid oklch(0.22 0.04 250)" : "1px solid transparent"
      },
      children: [
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    className: "w-8 h-8 rounded-lg flex items-center justify-center",
                    style: {
                      background: "linear-gradient(135deg, oklch(0.55 0.24 255), oklch(0.68 0.22 165))"
                    },
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { size: 16, className: "text-white" })
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Finance Pro Community" })
              ]
            }
          ),
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative max-w-4xl mx-auto px-4 sm:px-6 py-20 flex flex-col items-center text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6", children: [
            "Learn Finance, Grow Your Knowledge & Join Our",
            " ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Expert Community" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Join our free Telegram community where thousands of people learn financial markets, investment strategies, and wealth-building principles together."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-8 mt-2 mb-14", children: [
            { value: "10K+", label: "Members" },
            { value: "Daily", label: "Insights" },
            { value: "Free", label: "To Join" }
          ].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-2xl font-bold text-blue-glow", children: s.value }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                className: "text-sm",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CommunityDashboard, {}) })
        ] })
      ]
    }
  );
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { size: 22, style: { color: item.color } })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "h3",
...
function Features() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "features", className: "py-20 section-bg-alt", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: titleRef, className: "reveal text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold", children: [
        "Everything You Need to",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Master Finance" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(FeatureCard, { item }, item.title)) })
  ] }) });
}
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { size: 26, className: "text-blue-glow" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
...
function HowItWorks() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "how-it-works", className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: titleRef, className: "reveal text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold", children: [
        ...
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "3 Easy Steps" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: steps.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(StepCard, { item: s }, s.step)) }),
...
function StatCard({ item }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: { transitionDelay: `${item.delay}ms` },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { size: 24, className: "text-blue-glow mx-auto mb-2" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-3xl font-bold gradient-text mb-1", children: item.value }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm", style: { color: "oklch(0.58 0.04 240)" }, children: item.label })
      ]
    }
  );
}
...
function Insights() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "insights", className: "py-20 section-bg-alt", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: titleRef, className: "reveal text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          className: "text-sm font-semibold uppercase tracking-widest mb-3",
          style: { color: "oklch(0.62 0.22 255)" },
          children: "Community by the Numbers"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold", children: [
        "A Thriving ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Learning Community" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 mb-14", children: stats.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { item: s }, s.label)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: topics.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(TopicCard, { item: t }, t.title)) })
  ] }) });
}
function Community() {
  const ref = useReveal();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "community", className: "py-20", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 flex flex-col items-center gap-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref, className: "reveal w-full max-w-xl", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(GraduationCap, { size: 22, className: "text-white" })
              }
            ),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center max-w-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          className: "text-sm font-semibold uppercase tracking-widest mb-3",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold mb-6", children: [
        "We Make Finance",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Accessible to Everyone" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          style: { color: "oklch(0.68 0.04 240)" },
          children: "Finance Pro Community is a free Telegram group dedicated to financial education and market literacy. We share daily insights, analysis, and educational content to help you understand financial markets and make more informed decisions."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          style: { color: "oklch(0.68 0.04 240)" },
          children: "Our experienced team monitors financial markets daily and translates complex market movements into clear, educational content — so you always know what's happening and why."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "a",
...
function TestimonialCard({ item }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-1 mb-4", children: [1, 2, 3, 4, 5].slice(0, item.stars).map((n) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          Star,
          {
            size: 15,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs", style: { color: "oklch(0.55 0.04 240)" }, children: item.role })
          ] })
        ] })
      ]
    }
...
function Testimonials() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "testimonials", className: "py-20 section-bg-alt", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: titleRef, className: "reveal text-center mb-14", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold", children: [
        "Loved by",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Thousands of Learners" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: items.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(TestimonialCard, { item: t }, t.name)) })
  ] }) });
}
function CTA() {
  const ref = useReveal();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-24", id: "cta", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
        ...
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-3xl md:text-4xl font-bold mb-4", children: [
              "Join Our ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-text", children: "Free Community" }),
              " Today"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg mb-8", style: { color: "oklch(0.65 0.04 240)" }, children: "10,000+ members are already learning and growing together. Join free and start your financial education journey." }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap justify-center gap-6 mt-8", children: [
              { icon: CircleCheckBig, text: "100% Free" },
              { icon: CircleCheckBig, text: "No Spam" },
              { icon: CircleCheckBig, text: "Daily Content" }
            ].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                style: { color: "oklch(0.62 0.04 240)" },
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { size: 14, className: "text-green-glow" }),
                  item.text
                ]
              },
              item.text
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "footer",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-6 mb-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold gradient-text", children: "Finance Pro Community" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { style: { color: "oklch(0.65 0.06 50)" }, children: "⚠ Educational Disclaimer:" }),
              " ",
              "Finance Pro Community is for educational and informational purposes only. Content shared in our community does not constitute financial advice. We do not guarantee any financial outcomes. Always consult a qualified financial advisor before making investment decisions. Past market performance is not indicative of future results."
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                "© ",
                year,
                " Finance Pro Community. All rights reserved."
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubscribeBar, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Community, {}),
